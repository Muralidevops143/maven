...
package mobile.pe.source.example;
...
public class ExampleStream extends AbstractAdapterIncludedStream {
  ...
  public SpDataStream declareModel() {
    return DataStreamBuilder.create("mobile.pe.source.example")
          ...
          .protocol(Protocols.kafka(Config.INSTANCE.getKafkaHost(), Config.INSTANCE.getKafkaPort(), "mobile.source.jvm"))
          .build();
  }
